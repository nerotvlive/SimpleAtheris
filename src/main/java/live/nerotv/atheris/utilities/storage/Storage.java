package live.nerotv.atheris.utilities.storage;

import live.nerotv.atheris.utilities.storage.types.Config;
import live.nerotv.atheris.utilities.storage.types.MySQL;
import live.nerotv.atheris.utilities.storage.types.SQLite;
...
public class Storage {
    ...
    public boolean has(String table, String path) {
        if (type == storageType.YAML) {
            return yaml.get(path) != null;
        } else {
            String data = null;
